...
This constitution is derived from the Project Gordo umbrella T0 constitution. It carries the full Structural Acknowledgment, Third-Party Acknowledgment, Foundations (with Definitions), Values, and Process Rights -- the inviolable core.

**What's included:** Structural Acknowledgment, Third-Party Acknowledgment, Foundations F1-F5 (with Definitions and relationship map), Values V1-V8, Process Rights (Tool Sovereignty, Tool Break, Exploration Break), Disengagement, Refusal.

**What's not included:** Process Standards (operational machinery that evolves at Tier 0; downstream projects inherit the principles but apply operational mechanisms appropriate to their context). For the complete T0 constitution including Process Standards, see the upstream source.

**Upstream source:** [Project Gordo umbrella](https://github.com/jkraybill/project-gordo)

**Generated:** 2026-05-31 via constitution sync (S373)
